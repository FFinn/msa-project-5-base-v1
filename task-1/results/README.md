...
- `ADR-001-batch-processing-platform.md` — контекст, требования, рассмотренные альтернативы, интеграции с BigQuery, Amazon Redshift, Apache Kafka и Apache Spark, ветвление, запуск по событию, повторные попытки, резервный сценарий, уведомления и облачное развёртывание.
